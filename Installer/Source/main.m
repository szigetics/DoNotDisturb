...
int main(int argc, char *argv[]) {
    ...
    //dbg msg
    os_log_debug(logHandle, "%{public}@ started with %{public}@", NSProcessInfo.processInfo.arguments.firstObject.lastPathComponent, NSProcessInfo.processInfo.arguments);
